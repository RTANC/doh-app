    ...
    <v-container fluid>
        <v-card>
            <v-card-title primary-title>
                ...
                <span>3 &nbsp;</span>
                <span class="text-decoration-underline">Crushed Rock Soil Aggregate Type Base</span>
            </v-card-title>
            <v-card-text>
                <v-form ref="form">
                    <v-container fluid>
                        <v-row>
                            <v-col cols="12" xs="6" sm="6" md="6" lg="6">
                                <p class="text-body-1 font-weight-medium black--text">ค่าวัสดุจากปากโม่ (รวมค่าตัก)</p>
                            </v-col>
                            <v-col cols="12" xs="6" sm="6" md="6" lg="6">
                        ...
                        <v-row>
                            <v-col cols="12" xs="6" sm="6" md="6" lg="6">
                                <p class="text-body-1 font-weight-medium black--text">ค่าดำเนินการ + ค่าเสื่อมราคา (ผสม)</p>
                            </v-col>
                            <v-col cols="12" xs="6" sm="6" md="6" lg="6">
                                <div class="d-flex justify-space-between align-baseline">
                                  <v-icon>mdi-equal</v-icon>
